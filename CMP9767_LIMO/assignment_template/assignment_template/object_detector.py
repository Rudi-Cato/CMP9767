...
class ObjectDetector(Node):
    ...
    def image_color_callback(self, data):
        ...
        for centroid in self.centroid_coordinates:
            ...
            if 0.15 < depth_value < 1.14:                                                                  # filter out depth anomolies
        ...
        #define a point in camera coordinates
            ...
            if transform_map:
                ...
                if len(self.pothole_points)%20==0:                                                        # everytime list becomes divisible by modulo..
                                                                                                          # ..perform clustering
                ...
                # DBSCAN clustering       
                    dbscan = DBSCAN(eps=0.089, min_samples=2).fit(points)                                  # I use DBSCAN to cluster, this removes..
                    ...
                    print('the number of potholes in this list is: = ', len(Markers.markers))
        ...
        mask =cv2.resize(image_color, (0,0), fx=0.8, fy=0.8)
